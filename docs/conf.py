...
description = ''.join(['Tools for analysing Travelling Ionospheric and ',
                       'Atmospheric Disturbances in satellite and model data.'])
